...
export const DESTINATIONS: Destination[] = [
  {
    ...
    audioGuide: {
      ...
      narrator: '· Meitei Cultural Historian',
      duration: '3m 45s',
      durationSec: 225,
      languages: [
        {
  ...
  },
  {
    ...
    audioGuide: {
      ...
      narrator: 'Lake Ecosystem Custodian',
      duration: '4m 10s',
      durationSec: 250,
      languages: [
        {
        ...
        },
        {
          code: 'mni',
          label: 'ꯃৈতৈꯂꯣꯟ (Manipuri)',
          text: 'ꯅꯍꯥꯛꯅ ꯂꯣꯛꯇꯛ ꯂꯦꯛ ꯐꯥꯎꯗꯨꯅ ꯊꯤꯔꯤ, ꯑꯀꯣꯏꯕꯒꯤ ꯐꯤꯚꯝꯒꯤ ꯑꯣꯏꯕ ꯑꯑꯣꯟꯕ ꯑꯃ ꯒ꯭ꯔꯥꯍ ꯃꯥꯂꯦꯝꯗ ꯑꯇꯣꯞꯄ ꯃꯐꯝ ꯑꯃꯠꯇꯗ ꯐꯪꯗꯦ꯫ ꯑꯌꯨꯛꯀꯤ ꯀꯨꯍꯨꯝꯒꯤ ꯃꯈꯥꯗ ꯂꯤꯁꯤꯡ ꯀꯌꯥꯒꯤ ꯀꯣꯏꯔꯕ ꯐꯨꯝꯗꯤꯁꯤꯡ - ꯐꯨꯃꯁꯣꯡ ꯇꯦꯟꯇꯁꯤꯡꯗ ꯆꯠꯅꯕꯤꯒꯤ ꯑꯣꯏꯕ ꯥꯃꯤꯁꯤꯡꯕꯨ ꯁꯧꯒꯠꯄ, ꯑꯃꯁꯨꯡ ꯃꯥꯂꯦꯝꯒꯤ ꯑꯔꯣꯏꯕ ꯂꯝꯂꯛꯀꯤ ꯁꯉꯥꯏ ꯅꯥꯠꯀꯤ ꯁꯖꯤꯕꯨ ꯉꯥꯛꯊꯣꯛꯄ ꯍꯤꯡꯂꯤꯕ, ꯇꯨꯔꯦꯜ ꯇꯧꯔꯕ ꯊꯧꯗꯣꯛꯁꯤꯡ꯫',
        },
      ],
    },
    arExperience: {
    ...
    audioGuide: {
      ...
      languages: [
        ...
        },
        {
          code: 'mni',
          label: 'ꯃৈতৈꯂꯣꯟ (Manipuri)',
          text: 'ꯒꯣꯕꯤꯟꯗꯥꯖꯤ ꯂꯥꯏꯁꯪꯅ ꯃꯦꯏꯇꯦꯏ ꯚꯛꯇꯤꯅꯦꯜ ꯁꯤꯟꯇꯤꯁꯦꯁꯀꯤ ꯈ꯭ꯋꯥꯏꯗꯒꯤ ꯋꯥꯡꯕ ꯃꯐꯝ ꯑꯗꯨ ꯎꯠꯂꯤ, ꯃꯐꯝ ꯑꯗꯨꯗ ꯑꯔꯤꯕ ꯕꯦꯗꯤꯛ ꯀꯠꯊꯣꯛꯄ ꯑꯁꯤ ꯀ꯭ꯂꯥꯁꯤꯀꯦꯜ ꯃꯅꯤꯄꯨꯔꯤ ꯗꯥꯟꯁꯀꯤ ꯅꯨꯡꯁꯤꯖꯔꯕ ꯃꯑꯣꯡ ꯑꯃꯁꯨꯡ ꯐꯤꯚꯝꯒ ꯂꯣꯏꯅꯅ ꯄꯨꯟꯁꯤꯜꯂꯤ꯫ ꯅꯈꯣꯏꯒꯤ ꯃꯃꯥꯡꯗ ꯂꯩꯔꯤꯕ ꯀꯣꯔꯠꯌꯥꯔꯗ ꯑꯁꯤꯗ, ꯁꯦꯡꯂꯕ ꯔꯥꯁ ꯂꯤꯂꯥ ꯑꯁꯤ ꯊꯥ ꯊꯣꯛꯄ ꯀꯨꯝꯍꯩꯒꯤ ꯑꯇꯤꯌꯥꯒꯤ ꯃꯈꯥꯗ ꯄꯥꯡꯊꯣꯛꯏ꯫',
        },
      ],
    },
    arExperience: {
    ...
    audioGuide: {
      ...
      languages: [
        ...
        },
        {
          code: 'mni',
          label: 'ꯃৈতৈꯂꯣꯟ (Manipuri)',
          text: 'ꯅꯕꯦꯝꯕꯔ ꯈꯨꯗꯤꯡꯒꯤ, ꯃꯅꯤꯄꯨꯔꯒꯤ ꯄꯥꯠ ꯄꯨꯝꯅꯃꯛ ꯑꯁꯤ ꯃꯈꯣꯜꯒꯤ ꯀꯦꯂꯤꯗꯣꯁ꯭ꯀꯣꯞ ꯑꯃꯗ ꯄꯨꯟꯁꯤꯜꯂꯤ, ꯃꯆꯨ, ꯑꯃꯁꯨꯡ ꯃꯄꯥ - ꯃꯄꯨꯒꯤ ꯍꯦꯔꯤꯇꯦꯖ꯫ ꯁꯉꯥꯏ ꯀꯨꯝꯍꯩꯅ ꯏꯟꯗꯤꯖꯦꯅꯁ ꯇ꯭ꯔꯥꯏꯕꯦꯜ ꯗꯥꯟꯁ, ꯀ꯭ꯂꯥꯁꯤꯀꯦꯜ ꯔꯥꯁ ꯂꯤꯂꯥ, ꯈꯨꯗꯣꯡꯊꯤꯕ ꯊꯥꯡ - ꯇꯥ ꯃꯥꯔꯁꯤꯌꯦꯜ ꯑꯥꯔꯇꯤꯁ꯭ꯇ꯭ꯔꯤ, ꯑꯃꯁꯨꯡ ꯆꯠꯅꯕꯤꯒꯤ ꯑꯣꯏꯕ ꯏꯁꯤꯡꯒꯤ ꯁꯥꯟꯅ - ꯈꯣꯠꯅꯕꯁꯤꯡꯕꯨ ꯑꯆꯧꯕ ꯑꯇꯤꯌꯥ ꯑꯃꯒꯤ ꯃꯈꯥꯗ ꯄꯨꯅꯁꯤꯜꯂꯤ꯫',
        },
      ],
    },
    arExperience: {
